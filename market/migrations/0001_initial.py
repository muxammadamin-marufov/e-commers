# Generated by Django 6.0.3 on 2026-05-23 08:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.CharField(default='bi-grid', help_text='Bootstrap Icons nomini yozing (masalan: bi-laptop)', max_length=50)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Kutilmoqda ⏳'), ('processing', 'Tayyorlanmoqda 📦'), ('shipped', "Yo'lda 🚚"), ('delivered', 'Yetkazib berildi ✅'), ('canceled', 'Bekor qilindi ❌')], default='pending', max_length=20, verbose_name='Buyurtma holati')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_price', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True, verbose_name='Chegirmadagi narxi (ixtiyoriy)')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='market.category', verbose_name='Kategoriyasi')),
